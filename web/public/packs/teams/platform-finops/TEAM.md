...
- **Team dir:** `~/.hermes/teams/platform-finops/`
...
|--------|---------|------|-------------------|
| `@sre` | `sre` | **platform** | SRE — platform. |
| `@devops-automator` | `devops-automator` | **automation** | Devops Automator — automation. |
| `@infrastructure-maintainer` | `infrastructure-maintainer` | **infra** | Infrastructure Maintainer — infra. |
| `@finops-engineer` | `finops-engineer` | **cost** | FINOPS Engineer — cost. |
...
This crew is tuned for: *Cut our cloud bill 20% without degrading p95 latency this quarter*
...
Platform & FinOps standing rules:
