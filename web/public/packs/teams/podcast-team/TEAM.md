...
- **Team dir:** `~/.hermes/teams/podcast-team/`
...
|--------|---------|------|-------------------|
| `@podcast-strategist` | `podcast-strategist` | **strategy** | Podcast Strategist — strategy. |
| `@growth-hacker` | `growth-hacker` | **growth-loops** | Growth Hacker — growth-loops. |
| `@video-optimization-specialist` | `video-optimization-specialist` | **promo-clips** | Video Optimization Specialist — promo-clips. |
| `@pr-communications-manager` | `pr-communications-manager` | **press** | Pr Communications Manager — press. |
...
This crew is tuned for: *Take our B2B podcast from 500 to 20k monthly downloads: positioning, clip strategy, and a press plan*
...
Podcast Launch & Growth Team standing rules:
