...
- **Team dir:** `~/.hermes/teams/field-research-corp/`
...
|--------|---------|------|-------------------|
| `@anthropologist` | `anthropologist` | **field-methods** | Anthropologist — field-methods. |
| `@psychologist` | `psychologist` | **behavior** | Psychologist — behavior. |
| `@statistician` | `statistician` | **quant** | Statistician — quant. |
| `@narratologist` | `narratologist` | **narrative-analysis** | Narratologist — narrative-analysis. |
...
This crew is tuned for: *Design and analyze a user study of 60 participants: instruments, stats plan, and interpretation*
...
Field Research Corps standing rules:
