export const packTools = [
  ...
  },
  {
    ...
    title: "Get stall",
    description:
      "Get one mybot.farm stall by slug (gift-day, sprout-journal, patch, probe, pair-bench). Returns metadata plus download_pack and install-prompt API paths. Read-only.",
    method: "GET",
