...
- **Topology:** pipeline
- **Team dir:** `~/.hermes/teams/focus-audio-lab/`
...
|--------|---------|------|-------------------|
| `@focus-music-architect` | `focus-music-architect` | **scoring** | Focus Music Architect — scoring. |
| `@game-audio-engineer` | `game-audio-engineer` | **audio-systems** | Game Audio Engineer — audio-systems. |
| `@pitch` | `pitch` | **promotion** | Pitch — promotion. |
...
This crew is tuned for: *Score a 40-minute focus suite for our meditation app and package it for release with promo assets*
...
Focus Audio Lab standing rules:
