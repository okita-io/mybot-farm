...
- **Team dir:** `~/.hermes/teams/ai-app-crew/`
...
|--------|---------|------|-------------------|
| `@ai-engineer` | `ai-engineer` | **llm-features** | AI Engineer — llm-features. |
| `@voice-ai-integration-engineer` | `voice-ai-integration-engineer` | **voice** | Voice AI Integration Engineer — voice. |
| `@multi-agent-systems-architect` | `multi-agent-systems-architect` | **orchestration** | Multi Agent Systems Architect — orchestration. |
| `@prompt-engineer` | `prompt-engineer` | **prompts** | Prompt Engineer — prompts. |
...
This crew is tuned for: *Add a voice assistant that books appointments end-to-end into our product*
...
AI App Engineering Crew standing rules:
