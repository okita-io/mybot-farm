...
| ------------------- | -------- | ------------ | ----- | ------------- | ------------------ |
| openclaw-mybot-farm | high     | dynamic-tool | -     | -             | tools              |
...
| ------------------- | ---------------------- | ----- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ------------- |
| openclaw-mybot-farm | seam-inventory         | log   | observed 0 hooks, 0 registrations, and 1 manifest contracts                           | manifestContract:tools                                     | -             |
| openclaw-mybot-farm | hook-names-present     | log   | all observed hooks exist in the target OpenClaw hook registry                         | -                                                          | -             |
| openclaw-mybot-farm | api-registrars-present | log   | all observed api.register* calls exist in the target OpenClaw plugin API builder      | -                                                          | -             |
| openclaw-mybot-farm | sdk-exports-present    | log   | all observed plugin SDK imports exist in target OpenClaw package exports              | openclaw/plugin-sdk/tool-plugin                            | -             |
| openclaw-mybot-farm | package-metadata       | log   | selected package metadata for plugin contract checks                                  | package.json, @okita-io/openclaw-mybot-farm, version:0.1.1 | -             |
| openclaw-mybot-farm | declarative-contracts  | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                      | -             |
